...
public class PublicAsrActivity extends Activity {
	...
	private NlsRequest initNlsRequest() {
		NlsRequestProto proto = new NlsRequestProto(PublicAsrActivity.this);
	...
	private void initStartRecognizing() {
		mStartButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				mNlsRequest.authorize("L3Y1Fk8J0R5YzlQY", "jD6NheENLFrRGrnu3SlDL79O6D6rSA"); //请替换为用户申请到的数加认证key和密钥
				mNlsClient.start();
